...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_OTHER] = LAYOUT_80(
    ...
    _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,  _______, KC_MNXT,
    _______, _______, _______, _______, QK_RBT,   _______, _______, _______, _______, KC_PWR,  _______, _______, _______, _______,  KC_MPRV,
    KC_CAPS, _______, KC_SLEP, _______, _______,  _______, _______, _______, _______, QK_LOCK, _______, _______,          _______,  _______,
    _______,          _______, _______, KC_CALC,  _______, QK_BOOT, _______, _______, _______, _______, _______, _______, _______,  _______,
